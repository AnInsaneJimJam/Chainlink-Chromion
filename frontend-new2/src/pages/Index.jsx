...
useEffect(() => {
  ...
  if (header) {
    ...
    // Animate in after delay to sync with other components
    setTimeout(() => {
          ...
          <div className="min-h-screen flex flex-col items-center justify-center p-4 lg:p-8">
            <div className="w-full max-w-7xl mx-auto">
              ...
              <header className="text-center">
                ...
                >
                  Secure your digital assets for your loved ones. Create
                  tamper-proof wills and ensure seamless asset transfer when it
                  matters most.
                </motion.p>
              ...
              <main className="flex flex-col lg:flex-row justify-center items-center gap-8 my-8 lg:my-10">
                ...
                >
                  <div>
                    ...
                    >
                      Create and manage your digital will. Distribute your assets
                ...
                >
                  <div>
                    ...
                    >
                      View wills where you are named as a beneficiary. Track
                      status and initiate inheritance processes.
                    </p>
                  </div>
                  <button
              ...
              <section className="text-center pb-8">
                ...
                >
                  ...
                  >
                    ...
                    >
                      Your will is stored on blockchain, making it tamper-proof
                  ...
                  >
                    ...
                    >
                      Simple interface to create, edit, and manage your digital
                      inheritance plans.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    >
                      Assets are automatically transferred to beneficiaries when
                      conditions are met.
                    </p>
                  </motion.div>
                </motion.div>
