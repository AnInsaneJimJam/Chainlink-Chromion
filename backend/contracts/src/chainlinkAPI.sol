...
contract GettingStartedFunctionsConsumer is FunctionsClient, ConfirmedOwner {
    ...
    string source =
        "const name = args[0];"
        "const yearOfBirth = args[1];" // Changed from dateOfBirth
        "const apiResponse = await Functions.makeHttpRequest({"
        "url: `https://death-database-chainlink.vercel.app/death/${name}/${yearOfBirth}/is-dead`" // Changed from dateOfBirth
        "});"
